<template>
  <div style="
    background: url('/images/mirainikkibackground.jpg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center;" 
    class="py-8">
    <div
      class="scale-95 flex flex-col w-72 h-[1070px] diary-blue rounded-3xl border-4 border-[#21454c] place-self-center mx-auto my-10">
      <div class="h-full px-5 pt-8 pb-0 border-4 rounded-2xl border-[#21454c] rounded-b-none">
        <div class="bg-gray-800 w-full h-full rounded-b-none py-4 px-2 border-black border-2">
          <div class="flex flex-col bg-gray-300 w-full h-full max-h-[400px] overflow-y-auto scrollbar-subtle">
            <div class="bg-[#2e592c] relative flex items-center text-center w-full h-10">
      ...
      <div class="border-[#21454c] border-2 flex h-[75px] lg:h-[200px] bg-[#21454c] pb-2">
        ...
        <div class="relative w-full h-full bg-[#4596a9]">
          <div class="absolute grid grid-cols-3 -bottom-4 w-full h-1/2 bg-[#4c99ab] border-4 border-[#21454c]">
            <div class="bg-white bg-flex border-1 border-gray-900">
              <div class="h-2 bg-[#87b2bc]"></div>
              <div class="h-5 bg-[#4596a9]"></div>
              <div class="h-2 bg-[#537175]"></div>
            </div>
            <div class="bg-white bg-flex border-1 border-gray-900">
              <div class="h-2 bg-[#87b2bc]"></div>
              <div class="h-5 bg-[#4596a9]"></div>
      ...
      <div class="h-full diary-blue rounded-3xl">
        <div class="p-8 text-black space-y-4 mt-10 lg:mt-4">
          <div class="flex justify-around">
            <div class="flex justify-center items-center flex-col gap-4">
              <CornerUpLeft class="text-black border-black p-1 rounded-full bg-white border-1" :size="32" />
              <PhoneOutgoing class="text-black border-black p-1 rounded-full bg-white border-1" :size="32" />
            </div>
            <div class="scale-120">
              <div class="p-3 relative w-24 h-24 bg-white rounded-full border-1 border-black">
                <div class="absolute inset-0 rounded-full border m-1"></div>

                <button class="absolute top-3 left-1/2 -translate-x-1/2">
                  <ChevronUp />
                </button>
                ...
                <button class="absolute bottom-3 left-1/2 -translate-x-1/2">
                  <ChevronDown />
                </button>
            ...
            <div class="flex flex-col justify-center items-center gap-4">
              <Mail class="text-black border-black p-1 rounded-full bg-white border-1" :size="32" />
              <PhoneOff class="text-black border-black p-1 rounded-full bg-white border-1" :size="32" />
            </div>
          </div>

          <div class="grid grid-cols-3 gap-2">
            <button v-for="key in keypad" :key="key"
              class="bg-gray-100 text-sm text-center px-2 py-1 border-2 border-gray-500">
              {{ key }}
            </button>
          </div>

          <div class="w-16 h-2 bg-[#3f8a9b] border-1 border-black rounded-3xl place-self-center"></div>
        </div>
      </div>
    </div>
  </div>
