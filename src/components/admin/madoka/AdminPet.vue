...
const handleClick = () => {
  ...
  unlock({
    ...
    description:
      "Parabéns! Você descobriu que eu sou clicável. Agora, por favor, volte a explorar o website.",
    icon: "💢",
  });
...
<template>
  <div
    class="admin-pet-container fixed bottom-22 lg:bottom-12 left-0 md:left-0 flex flex-col items-end"
  >
    <div
