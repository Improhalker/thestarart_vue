...
<template>
  <aside class="space-y-4" aria-label="Informações complementares do post">
    <section class="border-2 border-black bg-[var(--ui-bg-secondary)] shadow-[6px_6px_0px_rgba(0,0,0,0.7)]">
      ...
      <div class="divide-y divide-[var(--ui-border)] p-2">
        ...
        >
          <img :src="item.thumbnail ?? '/images/banner.webp'" alt="" class="h-12 w-14 shrink-0 border border-black object-cover pixelated" loading="lazy" />
          <span class="min-w-0">
    ...
    <section class="border-2 border-black bg-[var(--ui-bg-secondary)] shadow-[6px_6px_0px_rgba(0,0,0,0.7)]">
      <CardWindowHeader title="SYSTEM_LOGS" />
